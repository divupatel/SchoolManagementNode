...
passport.use('student',new jwtStratagy (Studentopts,async function (payload,done){
    let checkStudentData = await Student.findOne({email : payload.studentToken.email})
    if(checkStudentData){
